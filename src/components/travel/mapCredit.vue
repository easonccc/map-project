    ...
    <div calss="content">
        <div class="right">
            ...
            <div class="grade">
                ...
                <div class="grade_content">评分图表</div>
            </div>
            <!-- 评价列表 -->
            <div class="list">
                <div class="list_title top-line">
                    评价列表
                    <div class="img">
                        <img src="../../assets/img/travel/链接.png" alt="" />
                    </div>
                </div>
                <div class="list_content">
                    <div class="list_item">
                        ...
                        <div class="icon">
                            <img
                                src="../../assets/img/travel/链接 拷贝.png"
                                alt=""
                            />
                        </div>
                    </div>
            ...
            <div class="dispose start_btn">发起处置</div>
            <div class="start_btn">
                启动预案
            </div>
        </div>
